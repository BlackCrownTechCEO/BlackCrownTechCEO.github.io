...
try {
  ...
  // Blog folder is intentionally absent in the BlackCrownTech portfolio build.
  // Emit empty posts/search indexes so downstream consumers stay happy.
  const posts = fs.existsSync(BLOG_FOLDER) ? getData(BLOG_FOLDER, 2) : [];
